  ...
  <section id="reviews" className="bg-icy py-14 md:py-20">
    <div className="container mx-auto">
      <div className="text-center mb-10 md:mb-14 scroll-animate">
        ...
        <h2 className="font-heading font-extrabold text-[28px] sm:text-[30px] md:text-[42px] text-navy">What Customers Say</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        {reviews.map((r, i) => (
          <div key={i} className="scroll-animate bg-card rounded-2xl p-5 sm:p-7 shadow-[0_2px_16px_rgba(13,31,92,0.06)] border-l-4 border-l-sky">
            <div className="text-amber text-lg mb-3">⭐⭐⭐⭐⭐</div>
            <p className="text-foreground/75 text-sm sm:text-[15px] leading-relaxed line-clamp-3">{r.text}</p>
            <div className="flex items-center gap-3 mt-4">
              ...
              <span className="bg-sky/10 text-primary text-[10px] font-semibold px-2 py-1 rounded-full whitespace-nowrap ml-auto hidden sm:inline">
                {r.service}
              </span>
            </div>
          </div>
